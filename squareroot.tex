...
\begin{questions}
  ...
  \begin{parts}
    ...
    \part Show that if $a$ is a square modulo $p$, then $x=a^{\frac{s+1}{2}}$ is a solution to $x^2\equiv a\pmod{p}$.
  ...
  \begin{parts}
    ...
    \part If $x^2\equiv a\pmod{p}$ you are done. Otherwise to complete our solution, we seek a square root $z$ of $-1$ modulo $p$. Let $z=$ and show that $z^2\equiv-1\pmod{p}$.
    \part Let $x_{\rm new}=xz$ and confirm that $x_{\rm new}$ is a square root of $a$ modulo $p$.
    \part Try your method on $p=$ and $a=$.
    \part Try your method on $p=$ and $a=$.
  \end{parts}
  \newpage
  \question Finally we will show part of the general method. Let $p=41$. We will try to find a square root of $a=5$.
  \begin{parts}
    ...
    \part This is a side step. Find any quadratic nonresidue $N$ and calculate $M=N^s$.
  ...
  \end{parts}
  We should note that there is a more efficient way to find the correct even power of $M$, but we will leave that for now!
\end{questions}
\end{document}
