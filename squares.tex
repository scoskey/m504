...
def squares(p):
  ...
  \vspace\fill
    \part Can you explain why the squares $i^2$ and $(p-i)^2$ are equivalent?
  \vspace\fill
    \part Can you explain why no other squares are equivalent?
  \vspace\fill
...
def legendre(a,p):
  ...
  \begin{parts}
    ...
    \vspace\fill
  \end{parts}
  Thanks to part (f), if $2,p_1,\ldots,p_k$ are primes, then the prime factors of $(2p_1\cdots p_k)^2+1$ are new primes $\equiv1\pmod{4}$!
\end{questions}
\end{document}
