...
\begin{questions}
  ...
  \]
  \begin{parts}
    \part Find the integer representation of the following message. Use blocks of two letters, then use blocks of four letters. You may use the provided \texttt{text2ints} function (the second argument is the block size).
    ...
    \[[162528172530, 302513112828, 351136152825]
    \]
  \end{parts}
  \newpage
