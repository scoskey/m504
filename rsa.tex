...
\begin{questions}
  ...
  \]
  \begin{parts}
    \part Find the integer representation of the following message. Use blocks of two letters, then use blocks of four letters. You may use the provided \texttt{text2int} function (the second argument is the block size).
    \[\texttt{`The years of rice and salt'}
    \]
    \vspace{2cm}
    \part Find the text represented by the following blocks of integers. You may use the provided \texttt{ints2text} function (the input must be an array).
    \[[162528172530, 30251311, 28283511, 36152825]
    \]
  \end{parts}
  \newpage
