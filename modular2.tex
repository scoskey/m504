...
def powerTable(n):
  ...
  \begin{parts}
    ...
    \vspace\fill
    \part Explain why if $a\in1,\ldots,p-1$ then the powers $a,a^2,\ldots,a^{p-1}\pmod{p}$ (the list may contain repeats) form a \emph{subgroup}, that is, they are also closed under the operations multiplication-modulo-$p$ and inverse-modulo-$p$.
    \vspace\fill
